...
public class TriggerAngular extends CommandBase {
...
//        angularVel = leftTrigger > SwerveConstants.TRIGGER_THRESHOLD ? leftTrigger * SwerveConstants.MAX_ANGULAR_VEL : -1 * rightTrigger * SwerveConstants.MAX_ANGULAR_VEL;
        ...
        angularVel = leftTrigger * SwerveConstants.MAX_ANGULAR_VEL + -rightTrigger * SwerveConstants.MAX_ANGULAR_VEL;
...
//        } else angularVel = Math.pow(rightX, 4) * SwerveConstants.MAX_ANGULAR_VEL;
        ...
        angularVel = OI.getInstance().getPS4Controller().getL1Button() ? -2 * angularVel : -angularVel;
