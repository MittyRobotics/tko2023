...
public class SwerveDriverPurePursuitCommand extends CommandBase {
    ...
    public SwerveDriverPurePursuitCommand(double linearThreshold, double angularThreshold, SwervePath... paths) {
