...
public class OneConePlusPreload extends SequentialCommandGroup {
    ...
    public OneConePlusPreload() {
        ...
        addCommands(
                new AutoArmScoreCommand(StateMachine.RobotState.HIGH, true),
...
//                new SwervePurePursuitCommand(2, 0.05, ),
                new AutoScoreCommand(Odometry.getInstance().getClosestScoringZone()[0], StateMachine.RobotState.HIGH, true)
        );
    }
}
