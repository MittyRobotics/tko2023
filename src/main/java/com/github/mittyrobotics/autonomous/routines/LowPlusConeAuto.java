...
public class LowPlusConeAuto extends SequentialCommandGroup {
    public LowPlusConeAuto(boolean leftSide, boolean balance) {
        ...
        Pose beforeFirstCone = new Pose(Point.add(firstCone.getPosition(), new Point(leftSide ? -60 : 60, 0)),
                starting.getHeading());
        ...
        addCommands(
                ...
                new PathFollowingCommand(
                        new SwervePath(
                                ...
                                10, 1, 1, 1, 0, 1, true
                        ), leftSide ? 0 : Math.PI, 2, 1, 0.2, 0.8, 3, 0, 0.02
                ),
                ...
                new PathFollowingCommand(
                        new SwervePath(
                                ...
                                10, 1, 1, 1, 1, 0, true
                        ), leftSide ? 0 : Math.PI, 2, 0.05, 0, 1, 3, 0, 0.02
                ),
