...
//        telescopeNeo.getPIDController().setOutputRange(-0.2, 0.2);
    ...
    private void createMPs() {
        ...
        TelescopeConstants.TELESCOPE_MPS.put(STOWED_TO_MID,
                new TrapezoidalMotionProfile(120 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 50 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 240 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 0, 0, 0 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 0 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 0.2));
        TelescopeConstants.TELESCOPE_MPS.put(STOWED_TO_HIGH,
                new TrapezoidalMotionProfile(100 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 50 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 240 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 0, 0, 0 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 0 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 0.2));
        ...
        TelescopeConstants.TELESCOPE_MPS.put(HP_TO_STOWED,
                new TrapezoidalMotionProfile(40 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 20 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 120 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 0, 0, 0 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 0 / 39.37 / TelescopeConstants.METERS_PER_MOTOR_REV, 0.2));
