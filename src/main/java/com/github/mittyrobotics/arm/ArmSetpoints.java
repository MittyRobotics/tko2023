...
public class ArmSetpoints {
    ...
    public static void initSetpoints() {
        ...
        positions.get(STOWED).put(NONE, new ArmPosition(new Angle(0, true), 0));
        ...
        positions.get(LOW).put(NONE, new ArmPosition(new Angle(0, true), 0));
        ...
        positions.get(MID).put(NONE, new ArmPosition(new Angle(0, true), 0));
        ...
        positions.get(HIGH).put(NONE, new ArmPosition(new Angle(0, true), 0));

        positions.get(HP).put(CONE, new ArmPosition(new Angle(0, true), 0));
        positions.get(HP).put(CUBE, new ArmPosition(new Angle(0, true), 0));
        positions.get(HP).put(NONE, new ArmPosition(new Angle(0, true), 0));

        positions.get(SCORING).put(CONE, new ArmPosition(new Angle(0, true), 0));
        positions.get(SCORING).put(CUBE, new ArmPosition(new Angle(0, true), 0));
        positions.get(SCORING).put(NONE, new ArmPosition(new Angle(0, true), 0));
        ...
        positions.get(RETRACTED).put(NONE, new ArmPosition(positions.get(SCORING).get(CUBE).getAngle(), 0));
    }
}
